    ...
    public function submit_login() {
        try {
            ...
            if (!empty($input)) {
                ...
                $params->select_values = array('u.*');
                $where1 = array("where_column" => 'u.username', "where_value" => $input->username);
                $where2 = array("where_column" => 'u.password', "where_value" => $input->password);
