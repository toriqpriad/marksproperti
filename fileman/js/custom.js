...
*/
		...
		var no = window.parent.selected_number();	
		var type = window.parent.selected_type();	  
		$(window.parent.document).find('#image_'+type+'_area_'+no).attr('src', file.fullPath);
		$(window.parent.document).find('#img_'+type+'_'+no).attr('value', file.name);
