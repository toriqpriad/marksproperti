...
<?php 
		...
		$dir = '../iproguide_new/public/assets/images/guides/'.$key.'/articles/content/' ;
		$ses_dir = '/iproguide_new/public/assets/images/guides/'.$key.'/articles/content/' ;
		//$create = mkdir($dir);
		$_SESSION['dir_upload_guide'] = $ses_dir ;				
		if(!is_dir($dir)){
