...
define('BACKEND_STATIC_FILES','http://localhost/properti_ci/public/assets/statics/backend/');
define('BACKEND_IMAGE_FOLDER','http://localhost/properti_ci/public/assets/images/backend/');
