...
define('BASE_URL', 'http://localhost/properti_ci/');
define('BACKEND_STATIC_FILES', BASE_URL . 'public/assets/statics/backend/');
define('FRONTEND_STATIC_FILES', BASE_URL . 'public/assets/statics/frontend/');
define('BACKEND_IMAGE_FOLDER', BASE_URL . 'public/assets/images/backend/');
...
define('ADMIN_WEBAPP_URL', "http://localhost/properti_ci/public/admin/");
define('UPLOADER_WEBAPP_URL', "http://localhost/properti_ci/public/assets/roxyfileman/index.php");
//define('UPLOADER_WEBAPP_URL', "http://localhost/properti_roxyfileman/index.php");
