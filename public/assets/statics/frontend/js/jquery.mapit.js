...
;(function($, window, undefined) {
	...
	$.fn.mapit = function(options) {
		...
		var defaults = {
			...
			styles: 'GRAYSCALE',
			locations: [
				[22.863440, 89.516720, 'images/map_marker.png', 'Cinema Aello 5+1', 'Panagi Tsaldari 140, Athina, Greece', true, '1'],
				[37.996547, 23.732001, 'images/marker_blue.png', 'Cinema Ilion', 'Τροίας 34, Αθήνα, Greece', true, '1'],
